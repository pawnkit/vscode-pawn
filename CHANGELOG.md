...
- Use signed toolchain set 33 with pawn v1.34.29, pawnlint v1.8.53, and
  pawnlsp v0.34.36.

## 0.18.77 - 2026-08-03

- Use signed toolchain set 32 with pawn v1.34.28, pawnlint v1.8.52, and
  pawnlsp v0.34.35.

## 0.18.76 - 2026-08-03

- Use signed toolchain set 31 with pawn v1.34.27, pawnlint v1.8.51, and pawnlsp v0.34.34.

## 0.18.75 - 2026-08-03

- Use signed toolchain set 30.

## 0.18.74 - 2026-08-03

- Use signed toolchain set 29 with pawnlint 1.8.50 and pawnlsp 0.34.33.

## 0.18.73 - 2026-08-03

- Use signed toolchain set 28 with pawnlint 1.8.49 and pawnlsp 0.34.32.
...
- Use signed toolchain set 26 with pawnlint 1.8.47 and pawnlsp 0.34.30.

## 0.18.70 - 2026-08-03

- Use corrected signed toolchain set 24.

## 0.18.69 - 2026-08-03

- Use signed toolchain set 23 with pawnlint 1.8.46 and pawnlsp 0.34.29.

## 0.18.68 - 2026-08-03

- Use signed toolchain set 22 with pawnlint 1.8.45 and pawnlsp 0.34.28.
...
- Use toolchain-signed-2026-08-03-15 with pawnlint 1.8.42.

## 0.18.60 - 2026-08-03

### Changed

- Use toolchain-signed-2026-08-03-14 with pawnlsp 0.34.24.

## 0.18.59 - 2026-08-03

### Changed

- Use toolchain-signed-2026-08-03-13 with pawn 1.34.24, pawnlint 1.8.41,
  and pawnlsp 0.34.23.
...
- Use toolchain-signed-2026-08-03-12 with pawnlsp v0.34.21.
...
- Use toolchain-signed-2026-08-03-10 with pawnlsp v0.34.19.

## 0.18.55 - 2026-08-03

### Changed

- Use toolchain-signed-2026-08-03-9 with pawnlsp v0.34.18.
...
- Use toolchain-signed-2026-08-03-7 with the latest CLI, formatter, linter, and
